...
if ($_POST) {
    ...
    if (empty($_POST['login'])) {
        ...
        $errors['login'] = "merci de renseigner un login dont la longueur est comprise 
        entre {$minLength} et {$maxLength} inclus";
    } elseif (preg_match('/^[a-zA-Z]+$/', $_POST['login']) === 0) {
        // le login est-il composé exclusivement de lettres de a à z, majuscules ou minuscules ?
        $errors['login'] = 'merci de renseigner un login composé uniquement de lettres 
        de l\'alphabet sans accent';
    }
